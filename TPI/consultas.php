...
<?php $user != null && ($user->isDocente() ||$user->isAdmin()) ? include_once('components/bloquearConsultaModal.php'):"";?>
<?php $user != null && ($user->isDocente() ||$user->isAdmin()) ? include_once('components/crearConsultaModal.php'):"";?>
